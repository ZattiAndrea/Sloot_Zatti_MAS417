...
def position_realizer(board_stl_file, fen):
    ...
    piece_files = {
        'p': 'models/pieces/black_pawn.stl',
        'r': 'models/pieces/black_rook.stl',
        'n': 'models/pieces/black_knight.stl',
        'b': 'models/pieces/black_bishop.stl',
        'q': 'models/pieces/black_queen.stl',
        'k': 'models/pieces/black_king.stl',
        'P': 'models/pieces/white_pawn.stl',
        'R': 'models/pieces/white_rook.stl',
        'N': 'models/pieces/white_knight.stl',
        'B': 'models/pieces/white_bishop.stl',
        'Q': 'models/pieces/white_queen.stl',
        'K': 'models/pieces/white_king.stl'
    }
    ...
    combined_mesh.save('models/boards/chessMoment.stl')
    print("Model saved.")
